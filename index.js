...
// 配置
const INPUT_PO_FILE = '/Users/wfq/work/uqf/uqpay-admin-panel/src/locales/zh/messages.po'; // 输入的 .po 文件路径
const OUTPUT_PO_FILE = '/Users/wfq/work/uqf/uqpay-admin-panel/message_translated.po'; // 输出的 .po 文件路径
...
const CACHE_FILE = path.resolve('/Users/wfq/work/uqf/uqpay-admin-panel/translation_cache.json'); // 缓存文件路径
