...
const OUTPUT_PO_FILE = '/Users/wfq/work/uqf/transfer_script/message_translated.po'; // 输出的 .po 文件路径
...
const CACHE_FILE = path.resolve('/Users/wfq/work/uqf/transfer_script/translation_cache.json'); // 缓存文件路径
